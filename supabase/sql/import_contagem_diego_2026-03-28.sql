...
INSERT INTO _rel_import_staging (
  ...
  (gen_random_uuid(), 10, 'Pedro', '01.04.0066', 'MASSA CONGELADA DE PÃO DE QUEIJO RECHEADO DE REQUEIJÃO 65G – CX 10 KG – 5 UN DE 2 KG', 'CX', 70, 22470, NULL, NULL, '2026-02-25'::date, '2026-09-21'::date, NULL, NULL, 'inventario', NULL, 1, 1, 'V', 4, 4, 1),
